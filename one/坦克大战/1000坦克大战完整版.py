...
class EnemyTank(Tank):
    ...
    def __init__(self, screen):
        ...
        self.rect = self.image.get_rect()
        self.rect.top = random.randint(0, TankGame.HEIGHT - self.rect.height)  # 随机生成Y轴的坐标
...
class Missile(BaseItem):
    ...
    def hit(self):
        ...
        if mm and len(mm)>0:
            ...
            #创建爆炸对象，显示爆炸效果
            TankGame.EXPOLE_LIST.append(Expole(self.screen, TankGame.MYTANK_LIST[0].rect.left, TankGame.MYTANK_LIST[0].rect.top))
...
class TankGame(object):
    ...
    def __init__(self):
        ...
        self.screen = pygame.display.set_mode((TankGame.WIDTH, TankGame.HEIGHT))
        # 设置窗口的标题
        ...
        for i in range(5):  # 游戏开始，生成5个敌方tank
            TankGame.ENMEY_TANK_LIST.append(EnemyTank(self.screen))  # 把生成的tank存储到敌方坦克列表里
        # 创建基地
        TankGame.WALL_LIST.append(Wall(self.screen, 435, 650, 4)) #  基地
        #  基地保护墙
        TankGame.WALL_LIST.append(Wall(self.screen, 400, 680, 5))
        TankGame.WALL_LIST.append(Wall(self.screen, 400, 650, 5))
        TankGame.WALL_LIST.append(Wall(self.screen, 400, 620, 5))
        TankGame.WALL_LIST.append(Wall(self.screen, 430, 620, 5))
        TankGame.WALL_LIST.append(Wall(self.screen, 460, 620, 5))
        TankGame.WALL_LIST.append(Wall(self.screen, 490, 620, 5))
        TankGame.WALL_LIST.append(Wall(self.screen, 490, 650, 5))
        TankGame.WALL_LIST.append(Wall(self.screen, 490, 680, 5))



        #  创建墙
        TankGame.WALL_LIST.append(Wall(self.screen, 180, 520, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 180, 580, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 180, 640, 0))

        TankGame.WALL_LIST.append(Wall(self.screen, 120, 0, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 120, 60, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 120, 120, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 120, 180, 3))
        TankGame.WALL_LIST.append(Wall(self.screen, 120, 240, 3))
        TankGame.WALL_LIST.append(Wall(self.screen, 120, 300, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 120, 360, 0))

        TankGame.WALL_LIST.append(Wall(self.screen, 180, 360,0))
        TankGame.WALL_LIST.append(Wall(self.screen, 240, 360, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 300, 360, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 360, 360, 1))
        TankGame.WALL_LIST.append(Wall(self.screen, 420, 360, 1))
        TankGame.WALL_LIST.append(Wall(self.screen, 480, 360, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 300, 120, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 300, 180, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 660, 0, 2))
        TankGame.WALL_LIST.append(Wall(self.screen, 660, 60, 2))
        TankGame.WALL_LIST.append(Wall(self.screen, 660, 120, 3))

        TankGame.WALL_LIST.append(Wall(self.screen, 180, 60,3))
        TankGame.WALL_LIST.append(Wall(self.screen, 240, 60, 3))
        TankGame.WALL_LIST.append(Wall(self.screen, 300, 60, 2))
        TankGame.WALL_LIST.append(Wall(self.screen, 360, 60, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 420, 60, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 480, 60, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 0, 0, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 0, 60, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 0, 120, 1))
        TankGame.WALL_LIST.append(Wall(self.screen, 0, 180, 1))
        TankGame.WALL_LIST.append(Wall(self.screen, 0, 240, 2))
        TankGame.WALL_LIST.append(Wall(self.screen, 0, 300, 2))
        TankGame.WALL_LIST.append(Wall(self.screen, 0, 360, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 60, 480, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 120, 480, 3))
        TankGame.WALL_LIST.append(Wall(self.screen, 180, 480, 3))
        TankGame.WALL_LIST.append(Wall(self.screen, 240, 480, 0))

        TankGame.WALL_LIST.append(Wall(self.screen, 360, 480, 2))
        TankGame.WALL_LIST.append(Wall(self.screen, 420, 480, 2))
        TankGame.WALL_LIST.append(Wall(self.screen, 480, 480, 2))
        TankGame.WALL_LIST.append(Wall(self.screen, 540, 480, 3))
        TankGame.WALL_LIST.append(Wall(self.screen, 600, 480, 1))
        TankGame.WALL_LIST.append(Wall(self.screen, 660, 480, 1))
        TankGame.WALL_LIST.append(Wall(self.screen, 720, 480, 0))

        TankGame.WALL_LIST.append(Wall(self.screen, 780, 480, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 780, 420,0))
        TankGame.WALL_LIST.append(Wall(self.screen, 780, 360, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 780, 300, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 780, 240, 0))

        TankGame.WALL_LIST.append(Wall(self.screen, 780, 180,0))
        TankGame.WALL_LIST.append(Wall(self.screen, 720, 180, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 660, 180, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 600, 180, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 540, 180, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 480, 180, 0))
        TankGame.WALL_LIST.append(Wall(self.screen, 480, 120, 0))
        ...
        for e in eventList:
            ...
            if e.type == KEYDOWN:
                if e.key == K_UP:  # 向上的方向键
                    ...
                    # 移动
                    # self.tank.move();
                if e.key == K_DOWN:  # 向上的方向键
                    self.tank.setDirection('D')
                    self.tank.stop = False
                    # self.tank.move();
                if e.key == K_LEFT:  # 向上的方向键
                    self.tank.setDirection('L')
                    self.tank.stop = False
                    # self.tank.move();
                if e.key == K_RIGHT:  # 向上的方向键
